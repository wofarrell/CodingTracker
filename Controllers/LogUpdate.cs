    ...
    public void LogOperation()
    {
        ...
        if (updateChoice != null)
        {
            ...
            if (updateChoiceId > 0)
            {
                ...
                do
                {
                    AnsiConsole.Markup("\nSelect the column by number below that needs to be updated (1-3), or type 'return'\n[grey]End time will be updated if 2 or 3 is chosen.[/]");
                    Console.WriteLine("\n1. Name \n2. Start Time \n3. End Time\nreturn");
                    ...
                    do
                    {
                        ...
                        {
                            if (inputChoice != null && (inputChoice == "1" || inputChoice == "2" || inputChoice == "3" || inputChoice == "return"))
                            {
